...
public enum ErrorCode {
    ...
    // Contacts
    CONTACT_NOT_FOUND, CONTACT_DUPLICATE, CONTACT_LABEL_NOT_FOUND, CONTACT_LABEL_DUPLICATE,

    // E-mail protocols
    MAIL_CONNECTION_ERROR, MAIL_AUTHENTICATION_FAILED, MAIL_OAUTH2_IMAP_ACCESS_DENIED, MAIL_OAUTH2_SCOPE_NOT_GRANTED, MAIL_ACCOUNT_REQUIRES_REAUTH, PROVIDER_NOT_FOUND, RESOURCE_NOT_FOUND, FOLDER_ROLE_NOT_FOUND,
