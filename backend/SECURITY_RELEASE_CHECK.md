...
| ----------------------- | ---------------------------------------------------------------- | ------- | ------- | ---------- | -------------- | ---------------------------------------------------------------------------------------- |
| B1 external mail server | [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md)                 | full    | 1.9     | 2026-09-22 | `6224cbb`      | **Open findings** — B1-4 (High), B1-3 and B1-5 (Medium), B1-6 (Low); B1-1 and B1-2 fixed |
