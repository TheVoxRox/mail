...
| ----------------------- | ---------------------------------------------------------------- | ------- | ------- | ---------- | -------------- | --------------------------------------------------- |
| B1 external mail server | [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md)                 | full    | 1.9     | 2026-09-22 | `6224cbb`      | **PASS** — B1-1 and B1-2 (Medium DoS) fixed in code |
...
| ------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.17    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.9 — a re-verification ahead of the ledger cap, so the anchor moves to `6224cbb` and the audit carries no acknowledged drift. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                            |
