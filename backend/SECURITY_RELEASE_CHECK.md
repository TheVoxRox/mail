...
| ----------------------- | ---------------------------------------------------------------- | ------- | ----- | ---------- | -------------- | --------------------------------------------------- |
| B1 external mail server | [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md)                 | full    | 1.6   | 2026-09-06 | `02ff962`      | **PASS** — B1-1 i B1-2 (Medium DoS) opraveny v kódu |
...
| B4 WebView ↔ SPA        | [CONTENT_RENDERING_AUDIT.md](../docs/CONTENT_RENDERING_AUDIT.md) | full    | 1.9   | 2026-09-03 | `0c1b61b`      | **PASS** — F1/F2/F3/F4/F5 opraveny                  |
...
| B6 Tauri updater        | [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md)                     | full    | 1.12  | 2026-09-07 | `0165149`      | **PASS** — U-1 opraven, bez otevřených nálezů       |
...
| ------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.6     | 2026-09-06               | Řádek B1 dorovnán na [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.6 (`02ff962`) — revize kvůli rozdělení IMAP spojení na dvě lane, ne kvůli stropu ledgeru: jedno tvrzení §1 přestalo platit. Verdikt beze změny (**PASS**), žádný nový nález.                                                                                                                                                                                        |
| 2.5     | 2026-09-02               | Řádek B1 dorovnán na [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.5 (`885b98a`) — re-verifikace vyvolaná stropem ledgeru, ne selháním. Verdikt beze změny (**PASS**), žádný nový nález. Zároveň opraven **neexistující SHA**: řádek pinoval B1 na `806528e`, což je pre-squash kotva a `git log` ji nenajde — táž past, kterou 2.2 zaznamenala u B6, tentokrát nezpozorovaná, protože audit sám vedle sebe měl post-squash `cad05cb`. |
