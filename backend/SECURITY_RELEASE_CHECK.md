...
| ----------------------- | ---------------------------------------------------------------- | ------- | ------- | ---------- | -------------- | --------------------------------------------------- |
| B1 external mail server | [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md)                 | full    | 1.15    | 2026-09-23 | `6224cbb`      | **PASS** — B1-1 to B1-7 fixed, B1-5 with a residual |
...
| B3 sidecar HTTP API     | [API_SURFACE_AUDIT.md](../docs/API_SURFACE_AUDIT.md)             | full    | 1.7     | 2026-09-26 | `6365fae`      | **PASS** — A1 (Low, defense-in-depth) fixed         |
| B4 WebView ↔ SPA        | [CONTENT_RENDERING_AUDIT.md](../docs/CONTENT_RENDERING_AUDIT.md) | full    | 2.0     | 2026-09-21 | `c0ff3b0`      | **PASS** — F1/F2/F3/F4/F5 fixed                     |
...
- [x] Production log level `INFO` (`src/main/resources/application.properties`); per the header of `application-dev.properties`, the dev profile with `DEBUG`/`show-sql` does not reach the release JAR. _Corrected 2026-09-26: it did reach the JAR, inactive unless the `dev` profile was switched on; it was deleted in #574, so the claim holds from then on._
...
| ------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.24    | 2026-09-26               | The B3 row follows [API_SURFACE_AUDIT.md](../docs/API_SURFACE_AUDIT.md) v1.7 — a §3 correction (the dev profile file did ship; #574 deleted it), anchor unchanged at `6365fae`. The verdict is unchanged (**PASS**). The log-hygiene claim of 2026-06-13 that repeated it carries a dated correction.                                                                                                                                                                                                                                                                                                                                                               |
| 2.23    | 2026-09-23               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.15 — B1-6 fixed, drift acknowledged, anchor unchanged at `6224cbb`. Nothing is left open, so the verdict returns to **PASS**, with B1-5's residual carried in the row.                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2.22    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.14 — B1-5 fixed with a residual (the body and headers of a draft composed elsewhere stay the server's, bounded but unverified), drift acknowledged, anchor unchanged at `6224cbb`. Verdict stays **open findings**, now for B1-6 alone.                                                                                                                                                                                                                                                                                                                                                      |
| 2.21    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.13 — B1-7 fixed, drift acknowledged, anchor unchanged at `6224cbb`. Verdict stays **open findings**, now for B1-5 and B1-6 alone.                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 2.20    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.12 — the packaged JVM exits on the first `OutOfMemoryError`, held back until the B1-3 fix; anchor unchanged at `6224cbb`. No finding changes state, verdict stays **open findings** for B1-5, B1-6 and B1-7.                                                                                                                                                                                                                                                                                                                                                                                 |
| 2.19    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.11 — B1-3 fixed, B1-7 found, drift acknowledged, anchor unchanged at `6224cbb`. Verdict stays **open findings** for B1-5, B1-6 and B1-7.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 2.18    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.10 — B1-4 fixed, drift acknowledged, anchor unchanged at `6224cbb`. Verdict stays **open findings** for B1-3, B1-5 and B1-6.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 2.17    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.9 — a re-verification ahead of the ledger cap, so the anchor moves to `6224cbb` and the audit carries no acknowledged drift. The verdict changes from **PASS** to **open findings**: B1-4 (High), B1-3 and B1-5 (Medium) and B1-6 (Low), found by the independent verification pass and not yet fixed.                                                                                                                                                                                                                                                                                       |
| 2.16    | 2026-09-22               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.8 — a documentation revision over acknowledged drift, so the anchor stays `9435e56`. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 2.15    | 2026-09-19               | The B3 row follows [API_SURFACE_AUDIT.md](../docs/API_SURFACE_AUDIT.md) v1.6 — a re-verification against `6365fae` that clears its acknowledgement run at 6 of 8. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2.14    | 2026-09-17               | The B3 row follows [API_SURFACE_AUDIT.md](../docs/API_SURFACE_AUDIT.md) v1.5 — a documentation revision over acknowledged drift, so the anchor stays `d45e253`. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2.13    | 2026-09-16               | The B1 row follows [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.7 — a re-verification at the ledger cap, so the anchor moves to `9435e56` and the audit carries no acknowledged drift. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 2.12    | 2026-09-16               | The B6 row follows [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md) v1.16 — a re-verification, so the anchor moves to `a2e6d43` and the audit carries no acknowledged drift. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2.11    | 2026-09-15               | The B6 row was aligned with [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md) v1.15 — a documentation revision over acknowledged drift, so the anchor stays `0165149`. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2.10    | 2026-09-14               | The B6 row was aligned with [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md) v1.14 — a documentation revision over acknowledged drift, so the anchor stays `0165149`. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2.9     | 2026-09-13               | The B6 row was aligned with [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md) v1.13 — a documentation revision over acknowledged drift, so the anchor stays `0165149`. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
