...
| ----------------------- | ---------------------------------------------------------------- | ------- | ------- | ---------- | -------------- | --------------------------------------------------------------------------------- |
| B1 external mail server | [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md)                 | full    | 1.14    | 2026-09-22 | `6224cbb`      | **Open findings** — B1-6 (Low); B1-1 to B1-5 and B1-7 fixed, B1-5 with a residual |
