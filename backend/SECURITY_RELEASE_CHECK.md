...
| B6 Tauri updater        | [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md)                     | full    | 1.16    | 2026-09-16 | `a471efb`      | **PASS** — U-1 fixed, no open findings              |
...
| ------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.12    | 2026-09-16               | The B6 row follows [UPDATER_AUDIT.md](../docs/UPDATER_AUDIT.md) v1.16 — a re-verification, so the anchor moves to `a471efb` and the audit carries no acknowledged drift. The verdict is unchanged (**PASS**).                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
