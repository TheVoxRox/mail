...
| ----------------------- | ---------------------------------------------------------------- | ------- | ----- | ---------- | -------------- | --------------------------------------------------- |
| B1 external mail server | [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md)                 | full    | 1.6   | 2026-09-06 | `b80c05f`      | **PASS** — B1-1 i B1-2 (Medium DoS) opraveny v kódu |
...
| ------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.6     | 2026-09-06               | Řádek B1 dorovnán na [IMAP_SMTP_AUDIT.md](../docs/IMAP_SMTP_AUDIT.md) v1.6 (`b80c05f`) — revize kvůli rozdělení IMAP spojení na dvě lane, ne kvůli stropu ledgeru: jedno tvrzení §1 přestalo platit. Verdikt beze změny (**PASS**), žádný nový nález.                                                                                                                                                                                        |
