...
- [ ] **Kontrola bezi jen pri startu.** [bootstrap.ts:201](frontend/src/lib/bootstrap.ts:201) je jedine volani, zadny periodicky re-check. S close-to-tray (`mail.closeAction`) muze instalace bezet tydny bez jedineho dotazu na endpoint. Doplnit interval radu hodin + check pri navratu okna z hidden. **[PRIVACY.md](PRIVACY.md) uz dnes tvrdi „aplikace se _periodicky_ pripojuje"** (bod 3 v „Jaka data putuji po siti") — tvrdi tedy vic egressu, nez se deje. Neni to riziko a nevzniklo to touhle revizi, ale znamena to, ze tenhle ukol dokument **narovna**, misto aby ho menil; kdyby se rozhodlo periodicky check nedelat, musi se opravit ta veta.
