...
- [ ] **Kontrola bezi jen pri startu.** [bootstrap.ts:201](frontend/src/lib/bootstrap.ts:201) je jedine volani, zadny periodicky re-check. S close-to-tray (`mail.closeAction`) muze instalace bezet tydny bez jedineho dotazu na endpoint. Doplnit interval radu hodin + check pri navratu okna z hidden.
