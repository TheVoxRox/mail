...
- [ ] **Re-verifikace auditu B4 (+4 commity), B5 (+2) a B2 (+1).** B1 a B6 hotove 2026-08-08 (B1 pri tom nasel a opravil B1-2). U zbylych tri drzi [docs/audit-freshness.json](docs/audit-freshness.json) poznamku, proc verdikt nejspis nehybe — ale skutecne precteni proti tvrzenim auditu jeste neprobehlo. Pred releasem dotahnout stejnym postupem jako B1: projit `git log <Audited commit>..HEAD -- <Code paths>`, overit kazde tvrzeni proti kodu, bumpnout kotvu.
