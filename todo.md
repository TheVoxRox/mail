...
- [x] Apt fetch v `Install Tauri system deps` pri degradovanem mirroru — HOTOVO 2026-08-27: timeout na obe schemata (stall byl na https), rozliseny exit 124/137 od chyby apt, `sleep` uz jen mezi pokusy. Pinnuti mirroru **zamitnuto** — zdroje na tom image jsou mirrorlist a hostitel, na ktery apt prepnul, je ten, ktery se pak zasekl; duvod je v hlavicce [.github/workflows/ci.yml](.github/workflows/ci.yml), detail v [CHANGELOG.md](CHANGELOG.md).
