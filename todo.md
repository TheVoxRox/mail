...
- [ ] **(5) IMAP fetch robustness — Seznam** INBOX vraci vsechny zpravy i s malformed BODYSTRUCTURE jako envelope-only stub + `contentError`. Zbyva — neni seznam.cz ucet k otestovani.
