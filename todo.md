...
- [ ] **Verified publisher (Partner One ID, drive MPN)** — JEDINY cisty produkcni blocker. Bez nej cizi Entra tenanty: "publisher not verified" / AADSTS700016 (repro 2026-05-20 s @tyflocentrum-ol.cz). Prereq "app pod Entra work/school uctem" uz splnen (info@voxrox.org). Postup (overeno 2026-06-20 z MS docs):
