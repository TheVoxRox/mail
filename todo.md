...
- [ ] **Beta guard odmitne legitimni stable hotfix.** [beta-channel.yml](.github/workflows/beta-channel.yml) bezi na kazdy publish a [beta-channel-guard.mjs](frontend/scripts/beta-channel-guard.mjs) porovnava plny SemVer: pri bete na `0.2.0-beta.1` skonci hotfix `0.1.1` exit 1 a workflow je cerveny, prestoze se stalo, co melo. [OPERATIONS.md](backend/OPERATIONS.md) „Release channels" resi jen promotion a HALT. Bud doplnit runbook, nebo v guardu ten pripad rozeznat a skoncit „skip, beta je napred".
