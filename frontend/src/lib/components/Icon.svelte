<script lang="ts" module>
	// Heroicons 24px outline/solid paths (MIT license).
	...
	const PATHS: Record<IconName, string> = {
		...
		swatch:
			'M10.5 3.75h3a2.25 2.25 0 0 1 2.25 2.25v.258c0 .597.237 1.17.659 1.591l1.742 1.742a2.25 2.25 0 0 1 .659 1.591V13.5a6.75 6.75 0 1 1-13.5 0V11.18c0-.597.237-1.17.659-1.591l1.742-1.742a2.25 2.25 0 0 0 .659-1.591V6a2.25 2.25 0 0 1 2.25-2.25ZM7.5 14.25h.008v.008H7.5v-.008Zm4.5 0h.008v.008H12v-.008Zm4.5 0h.008v.008H16.5v-.008Z',
		language:
			'M10.5 21l-1.5-1.5m0 0L3 13.5M9 19.5l6-15M21 6h-6m6 0v6m0-6-7.5 7.5M6.75 5.25h5.5M9.5 3v2.25m0 0A18.773 18.773 0 0 1 6 15.75m3.5-10.5A18.773 18.773 0 0 0 13 15.75m-7 0h7',
		keyboard:
			'M6.75 7.5h10.5A2.25 2.25 0 0 1 19.5 9.75v4.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 14.25v-4.5A2.25 2.25 0 0 1 6.75 7.5Zm.75 3h.008v.008H7.5V10.5Zm2.25 0h.008v.008H9.75V10.5Zm2.25 0h.008v.008H12V10.5Zm2.25 0h.008v.008H14.25V10.5Zm2.25 0h.008v.008H16.5V10.5ZM7.5 12.75h6v.75h-6v-.75Z',
		'information-circle':
			'M11.25 11.25 11.288 11.22a.75.75 0 0 1 1.212.59v4.19a.75.75 0 0 1-1.5 0v-2.94l-.038.03a.75.75 0 0 1-.924-1.182ZM12 8.25h.008v.008H12V8.25ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
		paperclip:
		...
		envelope:
			'M21.75 6.75v10.5A2.25 2.25 0 0 1 19.5 19.5h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0-8.72 5.813a1.875 1.875 0 0 1-2.08 0L2.25 6.75',
		...
		'arrow-uturn-left-double': 'M7.5 15 1.5 9l6-6M13.5 15l-6-6m0 0 6-6M7.5 9h9a6 6 0 0 1 0 12h-3',
	...
	const SOLID_FILL: Partial<Record<IconName, boolean>> = {
		star: true
	};
</script>
